...
public class TokenV2ControllerTest extends BaseRoomBookingTest {
   ...
   public void generateTokenTest() {
		...
		tokenV2Controller.generateToken(mockRequest,headers, "Test", "Test");
   }
    ...
    public void generateTokenTestWithoutOsid() {
 		...
 		profile.setMlifeNumber("123456");
 		response.setProfile(profile);
 		tokenV2Controller.generateToken(mockRequest,headers, null, null);
    }
    ...
    public void updateTokenTestStateNull() {
     	HttpServletRequest mockRequest = mock(HttpServletRequest.class);
 		Map<String, String> headers=new HashMap<>();
 		tokenV2Controller.updateToken(mockRequest,headers, "Test", null, "Test");
    }
    ...
    public void updateTokenTest() {
 		...
 		response.setProfile(profile);
 		Mockito.when(tokenService.generateV2Token(Mockito.any())).thenReturn(response);
 		tokenV2Controller.updateToken(mockRequest,headers, "Test", "Test", "Test");
    }
}
