...
@RequestMapping("/v4")
@V2Controller
public class ReservationV4Controller extends ExtendedBaseV2Controller {
    ...
    public CreateRoomReservationResponse reservation(@RequestHeader String source, @RequestHeader(
            ...
            //PaymentWidgetFlow
        createRoomReservationRequest.getRoomReservation().setSkipPaymentProcess(true);
        createRoomReservationRequest.getRoomReservation().setSkipFraudCheck(true);
    ...
    public CreatePartyRoomReservationResponse partyReservation(@RequestHeader String source, @RequestHeader(
        ...
        return reservationService.makePartyRoomReservationV4(createPartyRoomReservationRequest, skipMyVegasConfirm);
    }    
}
