...
public interface CancelReservationDAO {
     ...
     */
    RoomReservation cancelReservation(CancelRequest request);
    ...
    RoomReservation cancelPreviewReservation(CancelV2Request request);
    RoomReservation cancelCommitReservation(CancelV2Request request);
